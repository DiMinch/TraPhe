                        ...
                        return (
                          <div key={tier.id} className="p-4 rounded-xl border border-slate-100 hover:border-slate-200 bg-slate-50/50 transition-colors">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm mb-3 text-slate-600">
                              <div>
                                <span className="text-xs text-slate-400 block">Điểm tối thiểu</span>
                              ...
                              <div>
                                ...
                                <Badge className={tier.status === "ACTIVE" ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-600"}>
                                  {tier.status === "ACTIVE" ? "Đang áp dụng" : "Ngừng áp dụng"}
                                </Badge>
                              </div>
                            </div>
            ...
            <div className="lg:col-span-1">
                  ...
                  <div className="p-4 rounded-xl bg-indigo-50/50 border border-indigo-100 space-y-3">
                    ...
                    <div className="text-xs text-slate-600 space-y-1">
                      ...
                      <div className="flex justify-between font-medium text-slate-700">
                        ...
                        <span className="text-indigo-600">+{Math.floor(45000 / parseInt(pointRate || "1000"))} Điểm</span>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="shadow-md border border-slate-200 mt-6">
                ...
                <CardContent className="space-y-2 p-4">
                  <Button variant="ghost" className="w-full justify-between text-slate-700 hover:text-indigo-600 hover:bg-indigo-50" asChild>
